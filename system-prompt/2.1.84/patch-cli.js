...
const EXPECTED_HASHES = {
  ...
  'native-macos-arm64': '5c67dcef49b439f0e40111f29b64d9800e1f62736ca1b5ba20f2819b3622dee2',
...
function loadPatch(name) {
  ...
  if (fs.existsSync(findPath) && fs.existsSync(replacePath)) {
    const readPatchFile = (filePath) =>
      fs.readFileSync(filePath, 'utf8').replace(/\r?\n$/, '');

    return {
      find: readPatchFile(findPath),
      replace: readPatchFile(replacePath)
    };
  }
  return null;
}
